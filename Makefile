...
SRC = minishell.c \
		...
		utils/utils.c utils/free.c utils/errors.c utils/ft_split.c utils/get_next_line.c utils/ft_itoa.c \
		execution/exec.c  execution/exec_cmd.c execution/exec_ve.c execution/pipe.c execution/expand.c  execution/redirection.c execution/here_doc.c \
